...
const vocabDatabase: Record<string, VocabQuestion[]> = {
  ...
  // CHAPTER 7: CAUSEWAY BAY 銅鑼灣 - ⭐⭐⭐ HARD - Entertainment & dining (50 questions)
  cwb: [
    { type: 'meaning', hanzi: '銅鑼灣', pinyin: 'tung4 lo4 waan1', meaning: 'Causeway Bay', question: 'Chọn nghĩa đúng:', options: ['Central', 'TST', 'Causeway Bay', 'Mong Kok'], correctAnswer: 'Causeway Bay' },
    { type: 'pinyin', hanzi: '時代廣場', pinyin: 'si4 doi6 gwong2 coeng4', meaning: 'Times Square', question: 'Chọn jyutping đúng:', options: ['si4 doi6 gwong2 coeng4', 'hoi2 gong2 sing4', 'sogo', 'ifc'], correctAnswer: 'si4 doi6 gwong2 coeng4' },
    { type: 'hanzi', hanzi: 'SOGO', pinyin: 'sou1 gou1', meaning: 'SOGO (Sogo)', question: 'Chọn chữ Hán "SOGO":', options: ['時代廣場', 'SOGO', '崇光', '百貨'], correctAnswer: 'SOGO' },
    { type: 'sentence', hanzi: '百貨公司', pinyin: 'baak3 fo3 gung1 si1', meaning: 'Trung tâm bách hóa', question: 'Điền từ: 我去___買嘢。(Tôi đi trung tâm bách hóa mua đồ)', sentence: '我去百貨公司買嘢。', options: ['百貨公司', '超市', '街市', '商場'], correctAnswer: '百貨公司' },
    { type: 'meaning', hanzi: '戲院', pinyin: 'hei3 jyun2', meaning: 'Rạp phim', question: 'Chọn nghĩa đúng:', options: ['Nhà hát', 'Rạp phim', 'Trung tâm', 'Công viên'], correctAnswer: 'Rạp phim' },
    { type: 'pinyin', hanzi: '睇戲', pinyin: 'tai2 hei3', meaning: 'Xem phim', question: 'Chọn jyutping đúng:', options: ['tai2 hei3', 'coeng3 k', 'teng1 go1', 'tiu3 mou5'], correctAnswer: 'tai2 hei3' },
    { type: 'hanzi', hanzi: '電影', pinyin: 'din6 jing2', meaning: 'Phim', question: 'Chọn chữ Hán "Phim":', options: ['電視', '電影', '電話', '電腦'], correctAnswer: '電影' },
    { type: 'meaning', hanzi: '卡拉OK', pinyin: 'kaa1 laa1 ou1 kei1', meaning: 'Karaoke', question: 'Chọn nghĩa đúng:', options: ['Phòng trà', 'Karaoke', 'Quán bar', 'Disco'], correctAnswer: 'Karaoke' },
    { type: 'sentence', hanzi: '唱K', pinyin: 'coeng3 kei1', meaning: 'Đi hát karaoke', question: 'Điền từ: 我哋去___。(Chúng ta đi hát karaoke)', sentence: '我哋去唱K。', options: ['唱K', '睇戲', '食飯', '行街'], correctAnswer: '唱K' },
    { type: 'pinyin', hanzi: '飲嘢', pinyin: 'jam2 je5', meaning: 'Uống gì đó', question: 'Chọn jyutping đúng:', options: ['jam2 je5', 'sik6 je5', 'maai5 je5', 'tai2 je5'], correctAnswer: 'jam2 je5' },
    { type: 'meaning', hanzi: '食嘢', pinyin: 'sik6 je5', meaning: 'Ăn gì đó', question: 'Chọn nghĩa đúng:', options: ['Uống gì đó', 'Ăn gì đó', 'Mua gì đó', 'Xem gì đó'], correctAnswer: 'Ăn gì đó' },
    { type: 'hanzi', hanzi: '餐廳', pinyin: 'caan1 teng1', meaning: 'Nhà hàng', question: 'Chọn chữ Hán "Nhà hàng":', options: ['茶餐廳', '餐廳', '快餐店', '酒樓'], correctAnswer: '餐廳' },
    { type: 'meaning', hanzi: '茶餐廳', pinyin: 'caa4 caan1 teng1', meaning: 'Quán trà Hong Kong', question: 'Chọn nghĩa đúng:', options: ['Nhà hàng', 'Quán trà Hong Kong', 'Fast food', 'Quán cà phê'], correctAnswer: 'Quán trà Hong Kong' },
    { type: 'sentence', hanzi: '快餐', pinyin: 'faai3 caan1', meaning: 'Fast food', question: 'Điền từ: 我食___。(Tôi ăn fast food)', sentence: '我食快餐。', options: ['快餐', '正餐', '早餐', '晚餐'], correctAnswer: '快餐' },
    { type: 'pinyin', hanzi: '酒樓', pinyin: 'zau2 lau4', meaning: 'Nhà hàng Trung Hoa', question: 'Chọn jyutping đúng:', options: ['zau2 lau4', 'caa4 caan1 teng1', 'caan1 teng1', 'sik6 dim3'], correctAnswer: 'zau2 lau4' },
    { type: 'meaning', hanzi: '凍飲', pinyin: 'dung3 jam2', meaning: 'Đồ uống lạnh', question: 'Chọn nghĩa đúng:', options: ['Đồ uống nóng', 'Đồ uống lạnh', 'Đá', 'Nước sôi'], correctAnswer: 'Đồ uống lạnh' },
    { type: 'hanzi', hanzi: '熱飲', pinyin: 'jit6 jam2', meaning: 'Đồ uống nóng', question: 'Chọn chữ Hán "Đồ uống nóng":', options: ['凍飲', '熱飲', '冰', '茶'], correctAnswer: '熱飲' },
    { type: 'meaning', hanzi: '凍檸茶', pinyin: 'dung3 ning4 caa4', meaning: 'Trà chanh đá', question: 'Chọn nghĩa đúng:', options: ['Trà sữa', 'Trà chanh đá', 'Cà phê đá', 'Nước chanh'], correctAnswer: 'Trà chanh đá' },
    { type: 'sentence', hanzi: '奶茶', pinyin: 'naai5 caa4', meaning: 'Trà sữa', question: 'Điền từ: 我飲凍___。(Tôi uống trà sữa đá)', sentence: '我飲凍奶茶。', options: ['奶茶', '檸茶', '咖啡', '豆漿'], correctAnswer: '奶茶' },
    { type: 'pinyin', hanzi: '咖啡', pinyin: 'gaa3 fe1', meaning: 'Cà phê', question: 'Chọn jyutping đúng:', options: ['gaa3 fe1', 'naai5 caa4', 'ning4 caa4', 'dau6 zoeng1'], correctAnswer: 'gaa3 fe1' },
    { type: 'meaning', hanzi: '豆漿', pinyin: 'dau6 zoeng1', meaning: 'Sữa đậu nành', question: 'Chọn nghĩa đúng:', options: ['Sữa bò', 'Sữa đậu nành', 'Sữa dừa', 'Sữa chua'], correctAnswer: 'Sữa đậu nành' },
    { type: 'hanzi', hanzi: '鮮奶', pinyin: 'sin1 naai5', meaning: 'Sữa tươi', question: 'Chọn chữ Hán "Sữa tươi":', options: ['豆漿', '鮮奶', '奶茶', '熱奶'], correctAnswer: '鮮奶' },
    { type: 'meaning', hanzi: '果汁', pinyin: 'gwo2 zap1', meaning: 'Nước ép trái cây', question: 'Chọn nghĩa đúng:', options: ['Nước ngọt', 'Nước ép trái cây', 'Nước suối', 'Nước đá'], correctAnswer: 'Nước ép trái cây' },
    { type: 'sentence', hanzi: '汽水', pinyin: 'hei3 seoi2', meaning: 'Nước ngọt có ga', question: 'Điền từ: 我想飲___。(Tôi muốn uống nước ngọt)', sentence: '我想飲汽水。', options: ['汽水', '果汁', '茶', '水'], correctAnswer: '汽水' },
    { type: 'pinyin', hanzi: '啤酒', pinyin: 'be1 zau2', meaning: 'Bia', question: 'Chọn jyutping đúng:', options: ['be1 zau2', 'hong4 zau2', 'baak6 zau2', 'zau2'], correctAnswer: 'be1 zau2' },
    { type: 'meaning', hanzi: '紅酒', pinyin: 'hung4 zau2', meaning: 'Rượu vang đỏ', question: 'Chọn nghĩa đúng:', options: ['Bia', 'Rượu vang đỏ', 'Rượu trắng', 'Whisky'], correctAnswer: 'Rượu vang đỏ' },
    { type: 'hanzi', hanzi: '白酒', pinyin: 'baak6 zau2', meaning: 'Rượu trắng', question: 'Chọn chữ Hán "Rượu trắng":', options: ['啤酒', '紅酒', '白酒', '洋酒'], correctAnswer: '白酒' },
    { type: 'meaning', hanzi: '醉', pinyin: 'zeoi3', meaning: 'Say rượu', question: 'Chọn nghĩa đúng:', options: ['Tỉnh', 'Say rượu', 'Mệt', 'Buồn ngủ'], correctAnswer: 'Say rượu' },
    { type: 'sentence', hanzi: '飽', pinyin: 'baau2', meaning: 'No', question: 'Điền từ: 我好___。(Tôi rất no)', sentence: '我好飽。', options: ['飽', '餓', '渴', '攰'], correctAnswer: '飽' },
    { type: 'pinyin', hanzi: '餓', pinyin: 'ngo6', meaning: 'Đói', question: 'Chọn jyutping đúng:', options: ['ngo6', 'baau2', 'hot3', 'gui6'], correctAnswer: 'ngo6' },
    { type: 'meaning', hanzi: '渴', pinyin: 'hot3', meaning: 'Khát', question: 'Chọn nghĩa đúng:', options: ['Đói', 'No', 'Khát', 'Mệt'], correctAnswer: 'Khát' },
    { type: 'hanzi', hanzi: '攰', pinyin: 'gui6', meaning: 'Mệt', question: 'Chọn chữ Hán "Mệt":', options: ['飽', '餓', '渴', '攰'], correctAnswer: '攰' },
    { type: 'meaning', hanzi: '好味道', pinyin: 'hou2 mei6 dou6', meaning: 'Ngon', question: 'Chọn nghĩa đúng:', options: ['Dở', 'Ngon', 'Cay', 'Mặn'], correctAnswer: 'Ngon' },
    { type: 'sentence', hanzi: '新鮮', pinyin: 'san1 sin1', meaning: 'Tươi', question: 'Điền từ: 呢啲好___。(Những cái này rất tươi)', sentence: '呢啲好新鮮。', options: ['新鮮', '唔新鮮', '壞', '臭'], correctAnswer: '新鮮' },
    { type: 'pinyin', hanzi: '香', pinyin: 'hoeng1', meaning: 'Thơm', question: 'Chọn jyutping đúng:', options: ['hoeng1', 'cau3', 'haam4', 'tim4'], correctAnswer: 'hoeng1' },
    { type: 'meaning', hanzi: '臭', pinyin: 'cau3', meaning: 'Thối', question: 'Chọn nghĩa đúng:', options: ['Thơm', 'Thối', 'Tươi', 'Ngon'], correctAnswer: 'Thối' },
    { type: 'hanzi', hanzi: '鹹', pinyin: 'haam4', meaning: 'Mặn', question: 'Chọn chữ Hán "Mặn":', options: ['甜', '酸', '苦', '鹹'], correctAnswer: '鹹' },
    { type: 'meaning', hanzi: '甜', pinyin: 'tim4', meaning: 'Ngọt', question: 'Chọn nghĩa đúng:', options: ['Mặn', 'Ngọt', 'Chua', 'Đắng'], correctAnswer: 'Ngọt' },
    { type: 'sentence', hanzi: '酸', pinyin: 'syun1', meaning: 'Chua', question: 'Điền từ: 呢個好___。(Cái này rất chua)', sentence: '呢個好酸。', options: ['酸', '甜', '苦', '辣'], correctAnswer: '酸' },
    { type: 'pinyin', hanzi: '苦', pinyin: 'fu2', meaning: 'Đắng', question: 'Chọn jyutping đúng:', options: ['fu2', 'tim4', 'syun1', 'laat6'], correctAnswer: 'fu2' },
    { type: 'meaning', hanzi: '辣', pinyin: 'laat6', meaning: 'Cay', question: 'Chọn nghĩa đúng:', options: ['Ngọt', 'Chua', 'Cay', 'Đắng'], correctAnswer: 'Cay' },
    { type: 'hanzi', hanzi: '凍', pinyin: 'dung3', meaning: 'Lạnh', question: 'Chọn chữ Hán "Lạnh":', options: ['熱', '凍', '暖', '涼'], correctAnswer: '凍' },
    { type: 'meaning', hanzi: '熱', pinyin: 'jit6', meaning: 'Nóng', question: 'Chọn nghĩa đúng:', options: ['Lạnh', 'Nóng', 'Ấm', 'Mát'], correctAnswer: 'Nóng' },
    { type: 'sentence', hanzi: '燙', pinyin: 'tong3', meaning: 'Bỏng', question: 'Điền từ: 好___呀！(Rất bỏng đó!)', sentence: '好燙呀！', options: ['燙', '凍', '熱', '涼'], correctAnswer: '燙' },
    { type: 'pinyin', hanzi: '雪糕', pinyin: 'syut3 gou1', meaning: 'Kem', question: 'Chọn jyutping đúng:', options: ['syut3 gou1', 'daan6 taai2', 'gai1 daan2', 'bing1 seoi2'], correctAnswer: 'syut3 gou1' },
    { type: 'meaning', hanzi: '蛋撻', pinyin: 'daan6 taat3', meaning: 'Bánh tart trứng', question: 'Chọn nghĩa đúng:', options: ['Kem', 'Bánh tart trứng', 'Bánh quy', 'Kẹo'], correctAnswer: 'Bánh tart trứng' },
    { type: 'hanzi', hanzi: '蛋糕', pinyin: 'daan6 gou1', meaning: 'Bánh ngọt / Bánh kem', question: 'Chọn chữ Hán "Bánh kem":', options: ['雪糕', '蛋撻', '蛋糕', '餅乾'], correctAnswer: '蛋糕' },
    { type: 'meaning', hanzi: '糖果', pinyin: 'tong4 gwo2', meaning: 'Kẹo', question: 'Chọn nghĩa đúng:', options: ['Bánh', 'Kẹo', 'Chocolate', 'Kem'], correctAnswer: 'Kẹo' },
    { type: 'sentence', hanzi: '朱古力', pinyin: 'zyu1 gu1 lik1', meaning: 'Chocolate', question: 'Điền từ: 我鍾意食___。(Tôi thích ăn chocolate)', sentence: '我鍾意食朱古力。', options: ['朱古力', '糖果', '餅乾', '蛋糕'], correctAnswer: '朱古力' },
    { type: 'pinyin', hanzi: '餅乾', pinyin: 'beng2 gon1', meaning: 'Bánh quy', question: 'Chọn jyutping đúng:', options: ['beng2 gon1', 'guk1 kek1', 'syut3 beng2', 'tong4 gwo2'], correctAnswer: 'beng2 gon1' },
  ],

  // CHAPTER 8: REPULSE BAY 淺水灣 - ⭐⭐⭐ HARD - Beach & relaxation (50 questions)
  repulsebay: [
    { type: 'meaning', hanzi: '淺水灣', pinyin: 'cin2 seoi2 waan1', meaning: 'Repulse Bay (Thiển Thủy Loan)', question: 'Chọn nghĩa đúng:', options: ['Deep Water Bay', 'Repulse Bay (Thiển Thủy Loan)', 'Victoria Bay', 'Kowloon Bay'], correctAnswer: 'Repulse Bay (Thiển Thủy Loan)' },
    { type: 'pinyin', hanzi: '沙灘', pinyin: 'saa1 taan1', meaning: 'Bãi biển', question: 'Chọn jyutping đúng:', options: ['saa1 taan1', 'hoi2 taan1', 'saan1 deng2', 'wu4 seoi2'], correctAnswer: 'saa1 taan1' },
    { type: 'hanzi', hanzi: '海灘', pinyin: 'hoi2 taan1', meaning: 'Bờ biển', question: 'Chọn chữ Hán "Bờ biển":', options: ['沙灘', '海灘', '山頂', '湖水'], correctAnswer: '海灘' },
    { type: 'sentence', hanzi: '海', pinyin: 'hoi2', meaning: 'Biển', question: 'Điền từ: 我去___游水。(Tôi đi biển bơi)', sentence: '我去海游水。', options: ['海', '河', '湖', '池'], correctAnswer: '海' },
    { type: 'meaning', hanzi: '游水', pinyin: 'jau4 seoi2', meaning: 'Bơi', question: 'Chọn nghĩa đúng:', options: ['Chạy', 'Bơi', 'Nhảy', 'Đi bộ'], correctAnswer: 'Bơi' },
    { type: 'pinyin', hanzi: '游泳', pinyin: 'jau4 wing6', meaning: 'Bơi lội', question: 'Chọn jyutping đúng:', options: ['jau4 wing6', 'paau2 bou6', 'tiu3 seoi2', 'haang4 lou6'], correctAnswer: 'jau4 wing6' },
    { type: 'hanzi', hanzi: '潛水', pinyin: 'cim4 seoi2', meaning: 'Lặn', question: 'Chọn chữ Hán "Lặn":', options: ['游水', '跳水', '潛水', '浮潛'], correctAnswer: '潛水' },
    { type: 'meaning', hanzi: '浮潛', pinyin: 'fau4 cim4', meaning: 'Lặn có ống thở', question: 'Chọn nghĩa đúng:', options: ['Lặn sâu', 'Lặn có ống thở', 'Bơi', 'Nhảy cầu'], correctAnswer: 'Lặn có ống thở' },
    { type: 'sentence', hanzi: '跳水', pinyin: 'tiu3 seoi2', meaning: 'Nhảy cầu', question: 'Điền từ: 佢鍾意___。(Anh ấy thích nhảy cầu)', sentence: '佢鍾意跳水。', options: ['跳水', '游水', '潛水', '浮潛'], correctAnswer: '跳水' },
    { type: 'pinyin', hanzi: '曬太陽', pinyin: 'saai3 taai3 joeng4', meaning: 'Tắm nắng', question: 'Chọn jyutping đúng:', options: ['saai3 taai3 joeng4', 'paau2 bou6', 'jau4 seoi2', 'wan2 gau3'], correctAnswer: 'saai3 taai3 joeng4' },
    { type: 'meaning', hanzi: '太陽', pinyin: 'taai3 joeng4', meaning: 'Mặt trời', question: 'Chọn nghĩa đúng:', options: ['Mặt trăng', 'Mặt trời', 'Sao', 'Mây'], correctAnswer: 'Mặt trời' },
    { type: 'hanzi', hanzi: '月亮', pinyin: 'jyut6 loeng6', meaning: 'Mặt trăng', question: 'Chọn chữ Hán "Mặt trăng":', options: ['太陽', '月亮', '星星', '雲'], correctAnswer: '月亮' },
    { type: 'meaning', hanzi: '星星', pinyin: 'sing1 sing1', meaning: 'Ngôi sao', question: 'Chọn nghĩa đúng:', options: ['Mặt trời', 'Mặt trăng', 'Ngôi sao', 'Mây'], correctAnswer: 'Ngôi sao' },
    { type: 'sentence', hanzi: '雲', pinyin: 'wan4', meaning: 'Mây', question: 'Điền từ: 天空有好多___。(Trên trời có nhiều mây)', sentence: '天空有好多雲。', options: ['雲', '星', '月', '日'], correctAnswer: '雲' },
    { type: 'pinyin', hanzi: '天空', pinyin: 'tin1 hung1', meaning: 'Bầu trời', question: 'Chọn jyutping đúng:', options: ['tin1 hung1', 'daai6 hoi2', 'daai6 dei6', 'san1 lam4'], correctAnswer: 'tin1 hung1' },
    { type: 'meaning', hanzi: '大海', pinyin: 'daai6 hoi2', meaning: 'Đại dương', question: 'Chọn nghĩa đúng:', options: ['Trời', 'Đất', 'Đại dương', 'Núi'], correctAnswer: 'Đại dương' },
    { type: 'hanzi', hanzi: '大地', pinyin: 'daai6 dei6', meaning: 'Đại địa / Đất', question: 'Chọn chữ Hán "Đất":', options: ['天空', '大海', '大地', '森林'], correctAnswer: '大地' },
    { type: 'meaning', hanzi: '森林', pinyin: 'sam1 lam4', meaning: 'Rừng', question: 'Chọn nghĩa đúng:', options: ['Biển', 'Rừng', 'Núi', 'Đồng cỏ'], correctAnswer: 'Rừng' },
    { type: 'sentence', hanzi: '沙', pinyin: 'saa1', meaning: 'Cát', question: 'Điền từ: 沙灘好多___。(Bãi biển có nhiều cát)', sentence: '沙灘好多沙。', options: ['沙', '石', '泥', '草'], correctAnswer: '沙' },
    { type: 'pinyin', hanzi: '石頭', pinyin: 'sek6 tau4', meaning: 'Đá', question: 'Chọn jyutping đúng:', options: ['sek6 tau4', 'saa1', 'nai4', 'cou2'], correctAnswer: 'sek6 tau4' },
    { type: 'meaning', hanzi: '貝殼', pinyin: 'bui3 hok3', meaning: 'Vỏ sò', question: 'Chọn nghĩa đúng:', options: ['Cát', 'Đá', 'Vỏ sò', 'Sao biển'], correctAnswer: 'Vỏ sò' },
    { type: 'hanzi', hanzi: '海星', pinyin: 'hoi2 sing1', meaning: 'Sao biển', question: 'Chọn chữ Hán "Sao biển":', options: ['貝殼', '海星', '海馬', '海龜'], correctAnswer: '海星' },
    { type: 'meaning', hanzi: '海馬', pinyin: 'hoi2 maa5', meaning: 'Cá ngựa', question: 'Chọn nghĩa đúng:', options: ['Sao biển', 'Cá ngựa', 'Rùa biển', 'Tôm'], correctAnswer: 'Cá ngựa' },
    { type: 'sentence', hanzi: '海龜', pinyin: 'hoi2 gwai1', meaning: 'Rùa biển', question: 'Điền từ: 我睇到___！(Tôi thấy rùa biển!)', sentence: '我睇到海龜！', options: ['海龜', '海馬', '海星', '海豚'], correctAnswer: '海龜' },
    { type: 'pinyin', hanzi: '海豚', pinyin: 'hoi2 tyun4', meaning: 'Cá heo', question: 'Chọn jyutping đúng:', options: ['hoi2 tyun4', 'hoi2 gwai1', 'king4 jyu2', 'saa1 jyu2'], correctAnswer: 'hoi2 tyun4' },
    { type: 'meaning', hanzi: '鯨魚', pinyin: 'king4 jyu2', meaning: 'Cá voi', question: 'Chọn nghĩa đúng:', options: ['Cá heo', 'Cá voi', 'Cá mập', 'Cá ngừ'], correctAnswer: 'Cá voi' },
    { type: 'hanzi', hanzi: '鯊魚', pinyin: 'saa1 jyu2', meaning: 'Cá mập', question: 'Chọn chữ Hán "Cá mập":', options: ['鯨魚', '海豚', '鯊魚', '金魚'], correctAnswer: '鯊魚' },
    { type: 'meaning', hanzi: '浪', pinyin: 'long6', meaning: 'Sóng', question: 'Chọn nghĩa đúng:', options: ['Gió', 'Sóng', 'Nước', 'Mưa'], correctAnswer: 'Sóng' },
    { type: 'sentence', hanzi: '大浪', pinyin: 'daai6 long6', meaning: 'Sóng lớn', question: 'Điền từ: 今日有___。(Hôm nay có sóng lớn)', sentence: '今日有大浪。', options: ['大浪', '小浪', '無浪', '風浪'], correctAnswer: '大浪' },
    { type: 'pinyin', hanzi: '風', pinyin: 'fung1', meaning: 'Gió', question: 'Chọn jyutping đúng:', options: ['fung1', 'long6', 'jyu5', 'syut3'], correctAnswer: 'fung1' },
    { type: 'meaning', hanzi: '大風', pinyin: 'daai6 fung1', meaning: 'Gió to', question: 'Chọn nghĩa đúng:', options: ['Gió nhẹ', 'Gió to', 'Không gió', 'Bão'], correctAnswer: 'Gió to' },
    { type: 'hanzi', hanzi: '颱風', pinyin: 'toi4 fung1', meaning: 'Bão / Typhoon', question: 'Chọn chữ Hán "Bão":', options: ['大風', '颱風', '龍捲風', '微風'], correctAnswer: '颱風' },
    { type: 'meaning', hanzi: '雷', pinyin: 'leoi4', meaning: 'Sấm', question: 'Chọn nghĩa đúng:', options: ['Chớp', 'Sấm', 'Mưa', 'Tuyết'], correctAnswer: 'Sấm' },
    { type: 'sentence', hanzi: '閃電', pinyin: 'sim2 din6', meaning: 'Chớp / Sét', question: 'Điền từ: 有雷有___。(Có sấm có chớp)', sentence: '有雷有閃電。', options: ['閃電', '颱風', '大雨', '彩虹'], correctAnswer: '閃電' },
    { type: 'pinyin', hanzi: '彩虹', pinyin: 'coi2 hung4', meaning: 'Cầu vồng', question: 'Chọn jyutping đúng:', options: ['coi2 hung4', 'sim2 din6', 'leoi4', 'wan4'], correctAnswer: 'coi2 hung4' },
    { type: 'meaning', hanzi: '日出', pinyin: 'jat6 ceot1', meaning: 'Mặt trời mọc', question: 'Chọn nghĩa đúng:', options: ['Hoàng hôn', 'Mặt trời mọc', 'Giữa trưa', 'Nửa đêm'], correctAnswer: 'Mặt trời mọc' },
    { type: 'hanzi', hanzi: '日落', pinyin: 'jat6 lok6', meaning: 'Mặt trời lặn / Hoàng hôn', question: 'Chọn chữ Hán "Hoàng hôn":', options: ['日出', '日落', '黃昏', '黎明'], correctAnswer: '日落' },
    { type: 'meaning', hanzi: '黃昏', pinyin: 'wong4 fan1', meaning: 'Hoàng hôn', question: 'Chọn nghĩa đúng:', options: ['Bình minh', 'Hoàng hôn', 'Giữa trưa', 'Nửa đêm'], correctAnswer: 'Hoàng hôn' },
    { type: 'sentence', hanzi: '黎明', pinyin: 'lai4 ming4', meaning: 'Bình minh', question: 'Điền từ: ___時分好靚。(Lúc bình minh rất đẹp)', sentence: '黎明時分好靚。', options: ['黎明', '黃昏', '中午', '午夜'], correctAnswer: '黎明' },
    { type: 'pinyin', hanzi: '中午', pinyin: 'zung1 ng5', meaning: 'Trưa', question: 'Chọn jyutping đúng:', options: ['zung1 ng5', 'zou2 san4', 'je6 maan5', 'ng5 je6'], correctAnswer: 'zung1 ng5' },
    { type: 'meaning', hanzi: '午夜', pinyin: 'ng5 je6', meaning: 'Nửa đêm', question: 'Chọn nghĩa đúng:', options: ['Trưa', 'Nửa đêm', 'Sáng sớm', 'Chiều'], correctAnswer: 'Nửa đêm' },
    { type: 'hanzi', hanzi: '泳衣', pinyin: 'wing6 ji1', meaning: 'Đồ bơi', question: 'Chọn chữ Hán "Đồ bơi":', options: ['泳褲', '泳衣', '泳帽', '泳鏡'], correctAnswer: '泳衣' },
    { type: 'meaning', hanzi: '泳褲', pinyin: 'wing6 fu3', meaning: 'Quần bơi', question: 'Chọn nghĩa đúng:', options: ['Áo bơi', 'Quần bơi', 'Mũ bơi', 'Kính bơi'], correctAnswer: 'Quần bơi' },
    { type: 'sentence', hanzi: '泳帽', pinyin: 'wing6 mou6', meaning: 'Mũ bơi', question: 'Điền từ: 我戴___。(Tôi đội mũ bơi)', sentence: '我戴泳帽。', options: ['泳帽', '泳鏡', '耳塞', '鼻夾'], correctAnswer: '泳帽' },
    { type: 'pinyin', hanzi: '泳鏡', pinyin: 'wing6 geng2', meaning: 'Kính bơi', question: 'Chọn jyutping đúng:', options: ['wing6 geng2', 'wing6 mou6', 'ji5 coi3', 'bei6 gaap3'], correctAnswer: 'wing6 geng2' },
    { type: 'meaning', hanzi: '浮板', pinyin: 'fau4 baan2', meaning: 'Phao bơi', question: 'Chọn nghĩa đúng:', options: ['Kính bơi', 'Phao bơi', 'Ván lướt', 'Thuyền'], correctAnswer: 'Phao bơi' },
    { type: 'hanzi', hanzi: '衝浪板', pinyin: 'cung1 long6 baan2', meaning: 'Ván lướt sóng', question: 'Chọn chữ Hán "Ván lướt sóng":', options: ['浮板', '衝浪板', '滑板', '潛水板'], correctAnswer: '衝浪板' },
    { type: 'meaning', hanzi: '衝浪', pinyin: 'cung1 long6', meaning: 'Lướt sóng', question: 'Chọn nghĩa đúng:', options: ['Bơi', 'Lặn', 'Lướt sóng', 'Chèo thuyền'], correctAnswer: 'Lướt sóng' },
    { type: 'sentence', hanzi: '帆船', pinyin: 'faan4 syun4', meaning: 'Thuyền buồm', question: 'Điền từ: 我哋坐___。(Chúng tôi ngồi thuyền buồm)', sentence: '我哋坐帆船。', options: ['帆船', '快艇', '遊艇', '漁船'], correctAnswer: '帆船' },
    { type: 'pinyin', hanzi: '快艇', pinyin: 'faai3 teng5', meaning: 'Ca nô', question: 'Chọn jyutping đúng:', options: ['faai3 teng5', 'faan4 syun4', 'jau4 teng5', 'jyu4 syun4'], correctAnswer: 'faai3 teng5' },
  ],

  // CHAPTER 9: LAN KWAI FONG 蘭桂坊 - ⭐⭐⭐⭐ VERY HARD - Nightlife & western culture (50 questions)
  lkf: [
    { type: 'meaning', hanzi: '蘭桂坊', pinyin: 'laan4 gwai3 fong1', meaning: 'Lan Kwai Fong', question: 'Chọn nghĩa đúng:', options: ['Temple Street', 'Lan Kwai Fong', 'Mong Kok', 'Causeway Bay'], correctAnswer: 'Lan Kwai Fong' },
    { type: 'pinyin', hanzi: '酒吧', pinyin: 'zau2 baa1', meaning: 'Quán bar', question: 'Chọn jyutping đúng:', options: ['zau2 baa1', 'zau2 lau4', 'zau2 dim3', 'zau2 gaa1'], correctAnswer: 'zau2 baa1' },
    { type: 'hanzi', hanzi: '夜店', pinyin: 'je6 dim3', meaning: 'Club / Nightclub', question: 'Chọn chữ Hán "Club":', options: ['酒吧', '夜店', '餐廳', '茶餐廳'], correctAnswer: '夜店' },
    { type: 'sentence', hanzi: '夜生活', pinyin: 'je6 saang1 wut6', meaning: 'Cuộc sống về đêm', question: 'Điền từ: 蘭桂坊___好豐富。(Cuộc sống về đêm ở LKF rất phong phú)', sentence: '蘭桂坊夜生活好豐富。', options: ['夜生活', '日生活', '夜市', '夜景'], correctAnswer: '夜生活' },
    { type: 'meaning', hanzi: '豐富', pinyin: 'fung1 fu3', meaning: 'Phong phú / Phong phú', question: 'Chọn nghĩa đúng:', options: ['Nghèo nàn', 'Đơn điệu', 'Phong phú / Phong phú', 'Ít ỏi'], correctAnswer: 'Phong phú / Phong phú' },
    { type: 'pinyin', hanzi: '熱鬧', pinyin: 'jit6 naau6', meaning: 'Sôi động', question: 'Chọn jyutping đúng:', options: ['jit6 naau6', 'cing4 zing6', 'ngon6 zing6', 'mun6'], correctAnswer: 'jit6 naau6' },
    { type: 'hanzi', hanzi: '清靜', pinyin: 'cing1 zing6', meaning: 'Yên tĩnh', question: 'Chọn chữ Hán "Yên tĩnh":', options: ['熱鬧', '清靜', '嘈雜', '安靜'], correctAnswer: '清靜' },
    { type: 'meaning', hanzi: '嘈雜', pinyin: 'cou4 zaap6', meaning: 'Ồn ào', question: 'Chọn nghĩa đúng:', options: ['Yên tĩnh', 'Ồn ào', 'Thanh thản', 'Im lặng'], correctAnswer: 'Ồn ào' },
    { type: 'sentence', hanzi: '音樂', pinyin: 'jam1 ngok6', meaning: 'Âm nhạc', question: 'Điền từ: 我鍾意聽___。(Tôi thích nghe nhạc)', sentence: '我鍾意聽音樂。', options: ['音樂', '歌曲', '聲音', '噪音'], correctAnswer: '音樂' },
    { type: 'pinyin', hanzi: '跳舞', pinyin: 'tiu3 mou5', meaning: 'Nhảy múa', question: 'Chọn jyutping đúng:', options: ['tiu3 mou5', 'coeng3 go1', 'teng1 go1', 'zou6 jam1 ngok6'], correctAnswer: 'tiu3 mou5' },
    { type: 'meaning', hanzi: '跳舞機', pinyin: 'tiu3 mou5 gei1', meaning: 'Máy nhảy', question: 'Chọn nghĩa đúng:', options: ['Máy hát', 'Máy nhảy', 'Máy chơi game', 'DJ'], correctAnswer: 'Máy nhảy' },
    { type: 'hanzi', hanzi: 'DJ', pinyin: 'di1 zei1', meaning: 'DJ', question: 'Chọn chữ Hán "DJ":', options: ['歌手', 'DJ', '樂隊', '歌星'], correctAnswer: 'DJ' },
    { type: 'meaning', hanzi: '樂隊', pinyin: 'ngok6 deoi6', meaning: 'Ban nhạc', question: 'Chọn nghĩa đúng:', options: ['Ca sĩ', 'DJ', 'Ban nhạc', 'Nhạc sĩ'], correctAnswer: 'Ban nhạc' },
    { type: 'sentence', hanzi: '歌手', pinyin: 'go1 sau2', meaning: 'Ca sĩ', question: 'Điền từ: 佢係一個___。(Anh ấy là ca sĩ)', sentence: '佢係一個歌手。', options: ['歌手', 'DJ', '樂隊', '舞蹈員'], correctAnswer: '歌手' },
    { type: 'pinyin', hanzi: '舞蹈員', pinyin: 'mou5 dou6 jyun4', meaning: 'Vũ công', question: 'Chọn jyutping đúng:', options: ['mou5 dou6 jyun4', 'go1 sau2', 'ngok6 sau2', 'dung6 zeok3 jyun4'], correctAnswer: 'mou5 dou6 jyun4' },
    { type: 'meaning', hanzi: '外國人', pinyin: 'ngoi6 gwok3 jan4', meaning: 'Người nước ngoài', question: 'Chọn nghĩa đúng:', options: ['Người Trung Quốc', 'Người nước ngoài', 'Người Hồng Kông', 'Người Việt'], correctAnswer: 'Người nước ngoài' },
    { type: 'hanzi', hanzi: '鬼佬', pinyin: 'gwai2 lou2', meaning: 'Người Tây (thân mật)', question: 'Chọn chữ Hán "Người Tây":', options: ['外國人', '鬼佬', '本地人', '華人'], correctAnswer: '鬼佬' },
    { type: 'meaning', hanzi: '鬼妹', pinyin: 'gwai2 mui1', meaning: 'Cô Tây (thân mật)', question: 'Chọn nghĩa đúng:', options: ['Cô gái Trung Quốc', 'Cô Tây (thân mật)', 'Cô gái Hồng Kông', 'Cô gái Việt'], correctAnswer: 'Cô Tây (thân mật)' },
    { type: 'sentence', hanzi: '西人', pinyin: 'sai1 jan4', meaning: 'Người phương Tây', question: 'Điền từ: 好多___喺度。(Có nhiều người Tây ở đây)', sentence: '好多西人喺度。', options: ['西人', '東人', '南人', '北人'], correctAnswer: '西人' },
    { type: 'pinyin', hanzi: '英文', pinyin: 'jing1 man4', meaning: 'Tiếng Anh', question: 'Chọn jyutping đúng:', options: ['jing1 man4', 'gwong2 dung1 waa2', 'pou2 tung1 waa2', 'gwok3 jyu5'], correctAnswer: 'jing1 man4' },
    { type: 'meaning', hanzi: '廣東話', pinyin: 'gwong2 dung1 waa2', meaning: 'Tiếng Quảng Đông', question: 'Chọn nghĩa đúng:', options: ['Tiếng Anh', 'Tiếng Quảng Đông', 'Tiếng Quan Thoại', 'Tiếng Việt'], correctAnswer: 'Tiếng Quảng Đông' },
    { type: 'hanzi', hanzi: '普通話', pinyin: 'pou2 tung1 waa2', meaning: 'Tiếng Quan Thoại', question: 'Chọn chữ Hán "Tiếng Quan Thoại":', options: ['廣東話', '普通話', '英文', '法文'], correctAnswer: '普通話' },
    { type: 'meaning', hanzi: '講英文', pinyin: 'gong2 jing1 man4', meaning: 'Nói tiếng Anh', question: 'Chọn nghĩa đúng:', options: ['Nói tiếng Quảng', 'Nói tiếng Anh', 'Nói tiếng Quan Thoại', 'Nói tiếng Việt'], correctAnswer: 'Nói tiếng Anh' },
    { type: 'sentence', hanzi: '識講', pinyin: 'sik1 gong2', meaning: 'Biết nói', question: 'Điền từ: 我___英文。(Tôi biết nói tiếng Anh)', sentence: '我識講英文。', options: ['識講', '唔識講', '學講', '教講'], correctAnswer: '識講' },
    { type: 'pinyin', hanzi: '唔識講', pinyin: 'm4 sik1 gong2', meaning: 'Không biết nói', question: 'Chọn jyutping đúng:', options: ['m4 sik1 gong2', 'sik1 gong2', 'hok6 gong2', 'gaau3 gong2'], correctAnswer: 'm4 sik1 gong2' },
    { type: 'meaning', hanzi: '學', pinyin: 'hok6', meaning: 'Học', question: 'Chọn nghĩa đúng:', options: ['Dạy', 'Học', 'Biết', 'Quên'], correctAnswer: 'Học' },
    { type: 'hanzi', hanzi: '教', pinyin: 'gaau3', meaning: 'Dạy', question: 'Chọn chữ Hán "Dạy":', options: ['學', '教', '講', '聽'], correctAnswer: '教' },
    { type: 'meaning', hanzi: '認識', pinyin: 'jing6 sik1', meaning: 'Quen biết', question: 'Chọn nghĩa đúng:', options: ['Không quen', 'Quen biết', 'Yêu', 'Ghét'], correctAnswer: 'Quen biết' },
    { type: 'sentence', hanzi: '唔識', pinyin: 'm4 sik1', meaning: 'Không quen / Không biết', question: 'Điền từ: 我同佢___。(Tôi không quen anh ấy)', sentence: '我同佢唔識。', options: ['唔識', '識', '認識', '好熟'], correctAnswer: '唔識' },
    { type: 'pinyin', hanzi: '好熟', pinyin: 'hou2 suk6', meaning: 'Rất quen', question: 'Chọn jyutping đúng:', options: ['hou2 suk6', 'm4 suk6', 'jing6 sik1', 'm4 sik1'], correctAnswer: 'hou2 suk6' },
    { type: 'meaning', hanzi: '陌生', pinyin: 'mok6 saang1', meaning: 'Xa lạ / Lạ', question: 'Chọn nghĩa đúng:', options: ['Quen thuộc', 'Xa lạ / Lạ', 'Thân thiết', 'Yêu quý'], correctAnswer: 'Xa lạ / Lạ' },
    { type: 'hanzi', hanzi: '朋友', pinyin: 'pang4 jau5', meaning: 'Bạn', question: 'Chọn chữ Hán "Bạn":', options: ['敵人', '朋友', '陌生人', '家人'], correctAnswer: '朋友' },
    { type: 'meaning', hanzi: '死黨', pinyin: 'sei2 dong2', meaning: 'Bạn thân', question: 'Chọn nghĩa đúng:', options: ['Kẻ thù', 'Bạn thân', 'Người lạ', 'Đồng nghiệp'], correctAnswer: 'Bạn thân' },
    { type: 'sentence', hanzi: '好朋友', pinyin: 'hou2 pang4 jau5', meaning: 'Bạn tốt', question: 'Điền từ: 我哋係___。(Chúng ta là bạn tốt)', sentence: '我哋係好朋友。', options: ['好朋友', '死黨', '敵人', '陌生人'], correctAnswer: '好朋友' },
    { type: 'pinyin', hanzi: '敵人', pinyin: 'dik6 jan4', meaning: 'Kẻ thù', question: 'Chọn jyutping đúng:', options: ['dik6 jan4', 'pang4 jau5', 'gaa1 jan4', 'tung4 si6'], correctAnswer: 'dik6 jan4' },
    { type: 'meaning', hanzi: '拍拖', pinyin: 'paak3 to1', meaning: 'Hẹn hò', question: 'Chọn nghĩa đúng:', options: ['Cưới', 'Hẹn hò', 'Chia tay', 'Cãi nhau'], correctAnswer: 'Hẹn hò' },
    { type: 'hanzi', hanzi: '拍緊拖', pinyin: 'paak3 gan2 to1', meaning: 'Đang hẹn hò', question: 'Chọn chữ Hán "Đang hẹn hò":', options: ['拍拖', '拍緊拖', '分手', '結婚'], correctAnswer: '拍緊拖' },
    { type: 'meaning', hanzi: '分手', pinyin: 'fan1 sau2', meaning: 'Chia tay', question: 'Chọn nghĩa đúng:', options: ['Hẹn hò', 'Cưới', 'Chia tay', 'Yêu'], correctAnswer: 'Chia tay' },
    { type: 'sentence', hanzi: '結婚', pinyin: 'git3 fan1', meaning: 'Kết hôn', question: 'Điền từ: 佢哋___啦。(Họ kết hôn rồi)', sentence: '佢哋結婚啦。', options: ['結婚', '拍拖', '分手', '離婚'], correctAnswer: '結婚' },
    { type: 'pinyin', hanzi: '離婚', pinyin: 'lei4 fan1', meaning: 'Ly hôn', question: 'Chọn jyutping đúng:', options: ['lei4 fan1', 'git3 fan1', 'fan1 sau2', 'paak3 to1'], correctAnswer: 'lei4 fan1' },
    { type: 'meaning', hanzi: '單身', pinyin: 'daan1 san1', meaning: 'Độc thân', question: 'Chọn nghĩa đúng:', options: ['Đã có người yêu', 'Độc thân', 'Đã kết hôn', 'Đã ly hôn'], correctAnswer: 'Độc thân' },
    { type: 'hanzi', hanzi: '有對象', pinyin: 'jau5 deoi3 zoeng6', meaning: 'Có đối tượng / Có người yêu', question: 'Chọn chữ Hán "Có người yêu":', options: ['單身', '有對象', '離婚', '結婚'], correctAnswer: '有對象' },
    { type: 'meaning', hanzi: '冇對象', pinyin: 'mou5 deoi3 zoeng6', meaning: 'Không có đối tượng', question: 'Chọn nghĩa đúng:', options: ['Có người yêu', 'Không có đối tượng', 'Đã kết hôn', 'Đang hẹn hò'], correctAnswer: 'Không có đối tượng' },
    { type: 'sentence', hanzi: '鍾意', pinyin: 'zung1 ji3', meaning: 'Thích', question: 'Điền từ: 我___佢。(Tôi thích anh ấy)', sentence: '我鍾意佢。', options: ['鍾意', '唔鍾意', '愛', '恨'], correctAnswer: '鍾意' },
    { type: 'pinyin', hanzi: '愛', pinyin: 'oi3', meaning: 'Yêu', question: 'Chọn jyutping đúng:', options: ['oi3', 'zung1 ji3', 'zing1 jan4', 'cing4 jan4'], correctAnswer: 'oi3' },
    { type: 'meaning', hanzi: '恨', pinyin: 'han6', meaning: 'Ghét / Hận', question: 'Chọn nghĩa đúng:', options: ['Yêu', 'Thích', 'Ghét / Hận', 'Quý'], correctAnswer: 'Ghét / Hận' },
    { type: 'hanzi', hanzi: '親', pinyin: 'can3', meaning: 'Hôn', question: 'Chọn chữ Hán "Hôn":', options: ['愛', '親', '抱', '攬'], correctAnswer: '親' },
    { type: 'meaning', hanzi: '錫', pinyin: 'sek3', meaning: 'Hôn / Yêu chiều (Cantonese)', question: 'Chọn nghĩa đúng:', options: ['Đánh', 'Hôn / Yêu chiều (Cantonese)', 'Đẩy', 'Kéo'], correctAnswer: 'Hôn / Yêu chiều (Cantonese)' },
    { type: 'sentence', hanzi: '攬實', pinyin: 'laam5 sat6', meaning: 'Ôm chặt', question: 'Điền từ: 佢___我。(Anh ấy ôm chặt tôi)', sentence: '佢攬實我。', options: ['攬實', '親', '錫', '愛'], correctAnswer: '攬實' },
    { type: 'pinyin', hanzi: '抱住', pinyin: 'pou5 zyu6', meaning: 'Ôm / Bế', question: 'Chọn jyutping đúng:', options: ['pou5 zyu6', 'laam5 sat6', 'can3', 'sek3'], correctAnswer: 'pou5 zyu6' },
  ],

  // CHAPTER 10: WONG TAI SIN 黃大仙 - ⭐⭐⭐⭐ VERY HARD - Spirituality & fortune (50 questions)
  wongtaisin: [
    { type: 'meaning', hanzi: '黃大仙', pinyin: 'wong4 daai6 sin1', meaning: 'Hoàng Đại Tiên (Wong Tai Sin)', question: 'Chọn nghĩa đúng:', options: ['Quan Âm', 'Hoàng Đại Tiên (Wong Tai Sin)', 'Quan Đế', 'Thiên Hậu'], correctAnswer: 'Hoàng Đại Tiên (Wong Tai Sin)' },
    { type: 'pinyin', hanzi: '廟宇', pinyin: 'miu6 jyu5', meaning: 'Miếu / Đền thờ', question: 'Chọn jyutping đúng:', options: ['miu6 jyu5', 'zi6 miu6', 'si6 jyun6', 'gaau3 tong4'], correctAnswer: 'miu6 jyu5' },
    { type: 'hanzi', hanzi: '寺院', pinyin: 'zi6 jyun2', meaning: 'Chùa / Tự viện', question: 'Chọn chữ Hán "Chùa":', options: ['廟宇', '寺院', '教堂', '神殿'], correctAnswer: '寺院' },
    { type: 'sentence', hanzi: '拜拜', pinyin: 'baai3 baai3', meaning: 'Cúng bái', question: 'Điền từ: 我去廟度___。(Tôi đi chùa cúng bái)', sentence: '我去廟度拜拜。', options: ['拜拜', '祈禱', '許願', '捐錢'], correctAnswer: '拜拜' },
    { type: 'meaning', hanzi: '祈禱', pinyin: 'kei4 tou2', meaning: 'Cầu nguyện', question: 'Chọn nghĩa đúng:', options: ['Cúng bái', 'Cầu nguyện', 'Ước nguyện', 'Xin xăm'], correctAnswer: 'Cầu nguyện' },
    { type: 'pinyin', hanzi: '許願', pinyin: 'heoi2 jyun6', meaning: 'Ước nguyện', question: 'Chọn jyutping đúng:', options: ['heoi2 jyun6', 'kei4 tou2', 'baai3 baai3', 'kau4 cim1'], correctAnswer: 'heoi2 jyun6' },
    { type: 'hanzi', hanzi: '還神', pinyin: 'waan4 san4', meaning: 'Trả lễ thần (khi ước nguyện thành)', question: 'Chọn chữ Hán "Trả lễ thần":', options: ['拜神', '許願', '還神', '求神'], correctAnswer: '還神' },
    { type: 'meaning', hanzi: '神', pinyin: 'san4', meaning: 'Thần', question: 'Chọn nghĩa đúng:', options: ['Người', 'Thần', 'Quỷ', 'Yêu'], correctAnswer: 'Thần' },
    { type: 'sentence', hanzi: '佛', pinyin: 'fat6', meaning: 'Phật', question: 'Điền từ: 觀音___祖。(Phật Quan Âm)', sentence: '觀音佛祖。', options: ['佛', '神', '仙', '鬼'], correctAnswer: '佛' },
    { type: 'pinyin', hanzi: '仙', pinyin: 'sin1', meaning: 'Tiên', question: 'Chọn jyutping đúng:', options: ['sin1', 'san4', 'fat6', 'gwai2'], correctAnswer: 'sin1' },
    { type: 'meaning', hanzi: '鬼', pinyin: 'gwai2', meaning: 'Quỷ / Ma', question: 'Chọn nghĩa đúng:', options: ['Thần', 'Phật', 'Tiên', 'Quỷ / Ma'], correctAnswer: 'Quỷ / Ma' },
    { type: 'hanzi', hanzi: '妖怪', pinyin: 'jiu1 gwaai3', meaning: 'Yêu quái', question: 'Chọn chữ Hán "Yêu quái":', options: ['神仙', '佛祖', '妖怪', '鬼魂'], correctAnswer: '妖怪' },
    { type: 'meaning', hanzi: '觀音', pinyin: 'gun1 jam1', meaning: 'Quan Âm', question: 'Chọn nghĩa đúng:', options: ['Thần Tài', 'Quan Âm', 'Quan Đế', 'Thiên Hậu'], correctAnswer: 'Quan Âm' },
    { type: 'sentence', hanzi: '關公', pinyin: 'gwaan1 gung1', meaning: 'Quan Công', question: 'Điền từ: ___廟好靈驗。(Miếu Quan Công rất linh)', sentence: '關公廟好靈驗。', options: ['關公', '觀音', '天后', '黃大仙'], correctAnswer: '關公' },
    { type: 'pinyin', hanzi: '天后', pinyin: 'tin1 hau6', meaning: 'Thiên Hậu (Mazu)', question: 'Chọn jyutping đúng:', options: ['tin1 hau6', 'gun1 jam1', 'gwaan1 dai3', 'wong4 daai6 sin1'], correctAnswer: 'tin1 hau6' },
    { type: 'meaning', hanzi: '靈驗', pinyin: 'ling4 jim6', meaning: 'Linh nghiệm', question: 'Chọn nghĩa đúng:', options: ['Không linh', 'Linh nghiệm', 'Ma quái', 'Thần thánh'], correctAnswer: 'Linh nghiệm' },
    { type: 'hanzi', hanzi: '有求必應', pinyin: 'jau5 kau4 bit1 jing3', meaning: 'Cầu gì được nấy', question: 'Chọn chữ Hán "Cầu gì được nấy":', options: ['靈驗', '有求必應', '神通廣大', '保佑'], correctAnswer: '有求必應' },
    { type: 'meaning', hanzi: '保佑', pinyin: 'bou2 jau6', meaning: 'Phù hộ / Che chở', question: 'Chọn nghĩa đúng:', options: ['Trừng phạt', 'Phù hộ / Che chở', 'Nguyền rủa', 'Quở trách'], correctAnswer: 'Phù hộ / Che chở' },
    { type: 'sentence', hanzi: '保平安', pinyin: 'bou2 ping4 on1', meaning: 'Bảo trọng bình an', question: 'Điền từ: 我求神___。(Tôi cầu thần bảo trọng bình an)', sentence: '我求神保平安。', options: ['保平安', '保健康', '保財運', '保姻緣'], correctAnswer: '保平安' },
    { type: 'pinyin', hanzi: '平安', pinyin: 'ping4 on1', meaning: 'Bình an', question: 'Chọn jyutping đúng:', options: ['ping4 on1', 'gin6 hong1', 'coi4 wan6', 'jan1 jyun4'], correctAnswer: 'ping4 on1' },
    { type: 'meaning', hanzi: '健康', pinyin: 'gin6 hong1', meaning: 'Sức khỏe', question: 'Chọn nghĩa đúng:', options: ['Bệnh tật', 'Sức khỏe', 'Tiền bạc', 'Tình duyên'], correctAnswer: 'Sức khỏe' },
    { type: 'hanzi', hanzi: '財運', pinyin: 'coi4 wan6', meaning: 'Vận tài lộc', question: 'Chọn chữ Hán "Vận tài lộc":', options: ['平安', '健康', '財運', '姻緣'], correctAnswer: '財運' },
    { type: 'meaning', hanzi: '姻緣', pinyin: 'jan1 jyun4', meaning: 'Nhân duyên / Tình duyên', question: 'Chọn nghĩa đúng:', options: ['Tài lộc', 'Sức khỏe', 'Nhân duyên / Tình duyên', 'Sự nghiệp'], correctAnswer: 'Nhân duyên / Tình duyên' },
    { type: 'sentence', hanzi: '事業', pinyin: 'si6 jip6', meaning: 'Sự nghiệp', question: 'Điền từ: 希望___順利。(Hy vọng sự nghiệp thuận lợi)', sentence: '希望事業順利。', options: ['事業', '財運', '姻緣', '學業'], correctAnswer: '事業' },
    { type: 'pinyin', hanzi: '學業', pinyin: 'hok6 jip6', meaning: 'Học vấn / Học hành', question: 'Chọn jyutping đúng:', options: ['hok6 jip6', 'si6 jip6', 'gung1 zok3', 'san1 tai2'], correctAnswer: 'hok6 jip6' },
    { type: 'meaning', hanzi: '順利', pinyin: 'seon6 lei6', meaning: 'Thuận lợi', question: 'Chọn nghĩa đúng:', options: ['Khó khăn', 'Thuận lợi', 'Thất bại', 'Trắc trở'], correctAnswer: 'Thuận lợi' },
    { type: 'hanzi', hanzi: '成功', pinyin: 'sing4 gung1', meaning: 'Thành công', question: 'Chọn chữ Hán "Thành công":', options: ['失敗', '成功', '順利', '困難'], correctAnswer: '成功' },
    { type: 'meaning', hanzi: '失敗', pinyin: 'sat1 baai6', meaning: 'Thất bại', question: 'Chọn nghĩa đúng:', options: ['Thành công', 'Thất bại', 'Thuận lợi', 'Khó khăn'], correctAnswer: 'Thất bại' },
    { type: 'sentence', hanzi: '困難', pinyin: 'kwan3 naan4', meaning: 'Khó khăn', question: 'Điền từ: 遇到___要堅持。(Gặp khó khăn phải kiên trì)', sentence: '遇到困難要堅持。', options: ['困難', '順利', '成功', '容易'], correctAnswer: '困難' },
    { type: 'pinyin', hanzi: '容易', pinyin: 'jung4 ji6', meaning: 'Dễ dàng', question: 'Chọn jyutping đúng:', options: ['jung4 ji6', 'kwan3 naan4', 'gaan1 ci4', 'fong3 hei3'], correctAnswer: 'jung4 ji6' },
    { type: 'meaning', hanzi: '堅持', pinyin: 'gin1 ci4', meaning: 'Kiên trì / Kiên định', question: 'Chọn nghĩa đúng:', options: ['Từ bỏ', 'Kiên trì / Kiên định', 'Dễ dàng', 'Khó khăn'], correctAnswer: 'Kiên trì / Kiên định' },
    { type: 'hanzi', hanzi: '放棄', pinyin: 'fong3 hei3', meaning: 'Từ bỏ', question: 'Chọn chữ Hán "Từ bỏ":', options: ['堅持', '放棄', '繼續', '努力'], correctAnswer: '放棄' },
    { type: 'meaning', hanzi: '繼續', pinyin: 'gai3 zuk6', meaning: 'Tiếp tục', question: 'Chọn nghĩa đúng:', options: ['Dừng lại', 'Tiếp tục', 'Từ bỏ', 'Bắt đầu'], correctAnswer: 'Tiếp tục' },
    { type: 'sentence', hanzi: '努力', pinyin: 'nou5 lik6', meaning: 'Nỗ lực / Cố gắng', question: 'Điền từ: 要___學習。(Phải nỗ lực học tập)', sentence: '要努力學習。', options: ['努力', '放棄', '偷懶', '休息'], correctAnswer: '努力' },
    { type: 'pinyin', hanzi: '勤力', pinyin: 'kan4 lik6', meaning: 'Cần cù / Chăm chỉ', question: 'Chọn jyutping đúng:', options: ['kan4 lik6', 'laan5 do6', 'jau1 sik1', 'nou5 lik6'], correctAnswer: 'kan4 lik6' },
    { type: 'meaning', hanzi: '懶惰', pinyin: 'laan5 do6', meaning: 'Lười biếng', question: 'Chọn nghĩa đúng:', options: ['Chăm chỉ', 'Lười biếng', 'Nỗ lực', 'Kiên trì'], correctAnswer: 'Lười biếng' },
    { type: 'hanzi', hanzi: '聰明', pinyin: 'cung1 ming4', meaning: 'Thông minh', question: 'Chọn chữ Hán "Thông minh":', options: ['愚蠢', '聰明', '勤力', '懶惰'], correctAnswer: '聰明' },
    { type: 'meaning', hanzi: '愚蠢', pinyin: 'jyu4 ceon2', meaning: 'Ngu ngốc / Ngốc nghếch', question: 'Chọn nghĩa đúng:', options: ['Thông minh', 'Ngu ngốc / Ngốc nghếch', 'Khôn ngoan', 'Sáng suốt'], correctAnswer: 'Ngu ngốc / Ngốc nghếch' },
    { type: 'sentence', hanzi: '聰慧', pinyin: 'cung1 wai6', meaning: 'Sáng trí / Thông minh', question: 'Điền từ: 佢好___。(Anh ấy rất thông minh)', sentence: '佢好聰慧。', options: ['聰慧', '愚蠢', '懶惰', '笨'], correctAnswer: '聰慧' },
    { type: 'pinyin', hanzi: '笨', pinyin: 'ban6', meaning: 'Ngu / Đần', question: 'Chọn jyutping đúng:', options: ['ban6', 'cung1 ming4', 'lek1', 'lou5 sat1'], correctAnswer: 'ban6' },
    { type: 'meaning', hanzi: '叻', pinyin: 'lek1', meaning: 'Giỏi / Tài giỏi (Cantonese)', question: 'Chọn nghĩa đúng:', options: ['Ngu', 'Giỏi / Tài giỏi (Cantonese)', 'Dở', 'Kém'], correctAnswer: 'Giỏi / Tài giỏi (Cantonese)' },
    { type: 'hanzi', hanzi: '老實', pinyin: 'lou5 sat6', meaning: 'Thật thà / Chân thật', question: 'Chọn chữ Hán "Thật thà":', options: ['狡猾', '老實', '聰明', '笨'], correctAnswer: '老實' },
    { type: 'meaning', hanzi: '狡猾', pinyin: 'gaau2 waat6', meaning: 'Xảo trá / Gian xảo', question: 'Chọn nghĩa đúng:', options: ['Thật thà', 'Xảo trá / Gian xảo', 'Tốt bụng', 'Ngây thơ'], correctAnswer: 'Xảo trá / Gian xảo' },
    { type: 'sentence', hanzi: '善良', pinyin: 'sin6 loeng4', meaning: 'Lương thiện / Tốt bụng', question: 'Điền từ: 佢個人好___。(Con người anh ấy rất tốt bụng)', sentence: '佢個人好善良。', options: ['善良', '惡毒', '狡猾', '兇惡'], correctAnswer: '善良' },
    { type: 'pinyin', hanzi: '惡毒', pinyin: 'ok3 duk6', meaning: 'Ác độc / Độc ác', question: 'Chọn jyutping đúng:', options: ['ok3 duk6', 'sin6 loeng4', 'hou2 sam1', 'hap1 gwai2'], correctAnswer: 'ok3 duk6' },
    { type: 'meaning', hanzi: '好心', pinyin: 'hou2 sam1', meaning: 'Tốt bụng / Tốt tâm', question: 'Chọn nghĩa đúng:', options: ['Tâm địa xấu', 'Tốt bụng / Tốt tâm', 'Độc ác', 'Gian xảo'], correctAnswer: 'Tốt bụng / Tốt tâm' },
    { type: 'hanzi', hanzi: '壞心', pinyin: 'waai6 sam1', meaning: 'Tâm địa xấu', question: 'Chọn chữ Hán "Tâm địa xấu":', options: ['好心', '壞心', '善良', '老實'], correctAnswer: '壞心' },
    { type: 'meaning', hanzi: '有心', pinyin: 'jau5 sam1', meaning: 'Có ý / Có lòng tốt', question: 'Chọn nghĩa đúng:', options: ['Vô tâm', 'Có ý / Có lòng tốt', 'Xấu tính', 'Lười biếng'], correctAnswer: 'Có ý / Có lòng tốt' },
    { type: 'sentence', hanzi: '無心', pinyin: 'mou4 sam1', meaning: 'Vô tâm / Không cố ý', question: 'Điền từ: 我係___嘅。(Tôi không cố ý đâu)', sentence: '我係無心嘅。', options: ['無心', '有心', '好心', '壞心'], correctAnswer: '無心' },
    { type: 'pinyin', hanzi: '誠實', pinyin: 'sing4 sat6', meaning: 'Thành thật / Chân thành', question: 'Chọn jyutping đúng:', options: ['sing4 sat6', 'gaa2 waa6', 'ping3 jan4', 'daai6 waa6'], correctAnswer: 'sing4 sat6' },
  ],
};
...
export default function CantoneseStoryMode() {
  ...
  const [chapters, setChapters] = useState<Chapter[]>([
    ...
    },
    {
      ...
      location: '銅鑼灣 (Tung4 Lo4 Waan1)',
      description: 'Giải trí và ẩm thực hiện đại. 50 câu về Times Square, SOGO, karaoke, trà sữa.',
      icon: '🎬',
      difficulty: '⭐⭐⭐',
      lessons: generateLessons('cwb', 5),
      xpReward: 400,
      isUnlocked: true,
      isCompleted: false,
    },
    {
      id: '8',
      number: 8,
      title: 'Repulse Bay 淺水灣',
      location: '淺水灣 (Cin2 Seoi2 Waan1)',
      description: 'Bãi biển và thiên nhiên. 50 câu về bơi lội, lặn biển, động vật biển, thời tiết.',
      icon: '🏖️',
      difficulty: '⭐⭐⭐',
      lessons: generateLessons('repulsebay', 5),
      xpReward: 450,
      isUnlocked: true,
      isCompleted: false,
    },
    {
      ...
      location: '蘭桂坊 (Laan4 Gwai3 Fong1)',
      description: 'Cuộc sống về đêm và văn hóa phương Tây. 50 câu về bar, club, hẹn hò, tình yêu.',
      icon: '🍷',
      difficulty: '⭐⭐⭐⭐',
      lessons: generateLessons('lkf', 5),
      xpReward: 500,
      isUnlocked: true,
      isCompleted: false,
    },
    {
      ...
      location: '黃大仙 (Wong4 Taai3 Sin1)',
      description: 'Tâm linh và phúc lành. 50 câu về chùa miếu, cầu nguyện, đức tính, may mắn.',
      icon: '🙏',
      difficulty: '⭐⭐⭐⭐',
      lessons: generateLessons('wongtaisin', 5),
      xpReward: 550,
      isUnlocked: true,
      isCompleted: false,
    },
