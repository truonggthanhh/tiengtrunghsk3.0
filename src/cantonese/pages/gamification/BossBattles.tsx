...
const questionPool = [
  ...
  },
  {
    ...
    pinyin: 'xiè xiè',
    meaning: '?',
    options: ['Làm ơn', 'Xin lỗi', 'Cảm ơn', 'Xin phép'],
  ...
  },
  {
    ...
    pinyin: 'zài jiàn',
    meaning: '?',
    options: ['Xin chào', 'Tạm biệt', 'Hẹn gặp lại', 'Chúc ngủ ngon'],
  ...
  },
  {
    ...
    pinyin: 'duì bu qǐ',
    meaning: '?',
    options: ['Cảm ơn', 'Xin lỗi', 'Xin phép', 'Làm ơn'],
  ...
  },
  {
    ...
    pinyin: 'xué xí',
    meaning: '?',
    options: ['Học tập', 'Chơi', 'Làm việc', 'Ngủ'],
