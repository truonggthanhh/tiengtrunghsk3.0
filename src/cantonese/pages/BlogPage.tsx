        ...
        <div className="mb-8 text-center">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 text-left">Kiến thức học Tiếng Quảng Đông</p>
            </div>
          </div>
        </div>
