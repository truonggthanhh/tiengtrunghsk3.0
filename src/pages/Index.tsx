  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto p-4 md:p-8">
        ...
        <section ref={topicSectionRef} className="py-16 md:py-20 text-center scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="flex flex-col text-center h-full hover:shadow-xl hover:-translate-y-2 transition-all duration-300 ease-in-out group cursor-pointer hover:border-primary" onClick={handleSelectHsk}>
