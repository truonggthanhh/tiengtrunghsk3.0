...
const vocabDatabase: Record<string, VocabQuestion[]> = {
  ...
  beijing: [
    ...
    { type: 'hanzi', hanzi: '谢谢', pinyin: 'xiè xiè', meaning: 'Cảm ơn', question: 'Chọn chữ Hán có nghĩa "Cảm ơn":', options: ['谢谢', '对不起', '你好', '再见'], correctAnswer: '谢谢' },
    ...
    { type: 'hanzi', hanzi: '好', pinyin: 'hǎo', meaning: 'Tốt / Khỏe', question: 'Chọn chữ Hán có nghĩa "Tốt":', options: ['好', '坏', '大', '小'], correctAnswer: '好' },
    ...
    { type: 'hanzi', hanzi: '她', pinyin: 'tā', meaning: 'Cô ấy', question: 'Chọn chữ Hán có nghĩa "Cô ấy":', options: ['她', '他', '你', '我'], correctAnswer: '她' },
    ...
    { type: 'hanzi', hanzi: '什么', pinyin: 'shén me', meaning: 'Gì / Cái gì', question: 'Chọn chữ Hán có nghĩa "Gì":', options: ['什么', '哪里', '谁', '怎么'], correctAnswer: '什么' },
    ...
    { type: 'hanzi', hanzi: '也', pinyin: 'yě', meaning: 'Cũng', question: 'Chọn chữ Hán có nghĩa "Cũng":', options: ['也', '都', '还', '再'], correctAnswer: '也' },
    ...
    { type: 'hanzi', hanzi: '这', pinyin: 'zhè', meaning: 'Này', question: 'Chọn chữ Hán có nghĩa "Này":', options: ['这', '那', '哪', '什么'], correctAnswer: '这' },
    ...
    { type: 'hanzi', hanzi: '在', pinyin: 'zài', meaning: 'Ở / Tại', question: 'Chọn chữ Hán có nghĩa "Ở":', options: ['在', '去', '来', '从'], correctAnswer: '在' },
    ...
    { type: 'hanzi', hanzi: '多', pinyin: 'duō', meaning: 'Nhiều', question: 'Chọn chữ Hán có nghĩa "Nhiều":', options: ['多', '少', '大', '小'], correctAnswer: '多' },
  ...
  shanghai: [
    ...
    { type: 'hanzi', hanzi: '买', pinyin: 'mǎi', meaning: 'Mua', question: 'Chọn chữ Hán có nghĩa "Mua":', options: ['买', '卖', '看', '要'], correctAnswer: '买' },
    ...
    { type: 'hanzi', hanzi: '睡觉', pinyin: 'shuì jiào', meaning: 'Ngủ', question: 'Chọn chữ Hán có nghĩa "Ngủ":', options: ['睡觉', '起床', '工作', '学习'], correctAnswer: '睡觉' },
    ...
    { type: 'hanzi', hanzi: '去', pinyin: 'qù', meaning: 'Đi', question: 'Chọn chữ Hán có nghĩa "Đi":', options: ['去', '来', '在', '从'], correctAnswer: '去' },
    ...
    { type: 'hanzi', hanzi: '说', pinyin: 'shuō', meaning: 'Nói', question: 'Chọn chữ Hán có nghĩa "Nói":', options: ['说', '听', '看', '读'], correctAnswer: '说' },
    ...
    { type: 'hanzi', hanzi: '上网', pinyin: 'shàng wǎng', meaning: 'Lên mạng', question: 'Chọn chữ Hán có nghĩa "Lên mạng":', options: ['上网', '看书', '睡觉', '工作'], correctAnswer: '上网' },
    ...
    { type: 'hanzi', hanzi: '天', pinyin: 'tiān', meaning: 'Ngày / Trời', question: 'Chọn chữ Hán có nghĩa "Ngày":', options: ['天', '月', '年', '周'], correctAnswer: '天' },
    ...
    { type: 'hanzi', hanzi: '年', pinyin: 'nián', meaning: 'Năm', question: 'Chọn chữ Hán có nghĩa "Năm":', options: ['年', '月', '日', '周'], correctAnswer: '年' },
    ...
    { type: 'hanzi', hanzi: '上午', pinyin: 'shàng wǔ', meaning: 'Buổi sáng', question: 'Chọn chữ Hán có nghĩa "Buổi sáng":', options: ['上午', '下午', '晚上', '中午'], correctAnswer: '上午' },
    ...
    { type: 'hanzi', hanzi: '现在', pinyin: 'xiàn zài', meaning: 'Bây giờ', question: 'Chọn chữ Hán có nghĩa "Bây giờ":', options: ['现在', '刚才', '以后', '以前'], correctAnswer: '现在' },
    ...
    { type: 'hanzi', hanzi: '起床', pinyin: 'qǐ chuáng', meaning: 'Thức dậy', question: 'Chọn chữ Hán có nghĩa "Thức dậy":', options: ['起床', '睡觉', '休息', '工作'], correctAnswer: '起床' },
    ...
    { type: 'hanzi', hanzi: '早饭', pinyin: 'zǎo fàn', meaning: 'Bữa sáng', question: 'Chọn chữ Hán có nghĩa "Bữa sáng":', options: ['早饭', '午饭', '晚饭', '夜宵'], correctAnswer: '早饭' },
    ...
    { type: 'hanzi', hanzi: '跑步', pinyin: 'pǎo bù', meaning: 'Chạy bộ', question: 'Chọn chữ Hán có nghĩa "Chạy bộ":', options: ['跑步', '走路', '游泳', '骑车'], correctAnswer: '跑步' },
  ...
  greatwall: [
    ...
    { type: 'hanzi', hanzi: '文化', pinyin: 'wén huà', meaning: 'Văn hóa', question: 'Chọn chữ Hán có nghĩa "Văn hóa":', options: ['文化', '历史', '传统', '现代'], correctAnswer: '文化' },
    ...
    { type: 'hanzi', hanzi: '保护', pinyin: 'bǎo hù', meaning: 'Bảo vệ', question: 'Chọn chữ Hán có nghĩa "Bảo vệ":', options: ['保护', '破坏', '建设', '发展'], correctAnswer: '保护' },
    ...
    { type: 'hanzi', hanzi: '景点', pinyin: 'jǐng diǎn', meaning: 'Điểm tham quan', question: 'Chọn chữ Hán có nghĩa "Điểm tham quan":', options: ['景点', '商店', '餐厅', '酒店'], correctAnswer: '景点' },
    ...
    { type: 'hanzi', hanzi: '著名', pinyin: 'zhù míng', meaning: 'Nổi tiếng', question: 'Chọn chữ Hán có nghĩa "Nổi tiếng":', options: ['著名', '普通', '一般', '简单'], correctAnswer: '著名' },
    ...
    { type: 'hanzi', hanzi: '传统', pinyin: 'chuán tǒng', meaning: 'Truyền thống', question: 'Chọn chữ Hán có nghĩa "Truyền thống":', options: ['传统', '现代', '新式', '时尚'], correctAnswer: '传统' },
    ...
    { type: 'hanzi', hanzi: '防御', pinyin: 'fáng yù', meaning: 'Phòng thủ', question: 'Chọn chữ Hán có nghĩa "Phòng thủ":', options: ['防御', '进攻', '战斗', '胜利'], correctAnswer: '防御' },
    ...
    { type: 'hanzi', hanzi: '高大', pinyin: 'gāo dà', meaning: 'Cao lớn', question: 'Chọn chữ Hán có nghĩa "Cao lớn":', options: ['高大', '矮小', '宽阔', '狭窄'], correctAnswer: '高大' },
    ...
    { type: 'hanzi', hanzi: '石头', pinyin: 'shí tou', meaning: 'Đá', question: 'Chọn chữ Hán có nghĩa "Đá":', options: ['石头', '木头', '砖头', '土'], correctAnswer: '石头' },
    ...
    { type: 'hanzi', hanzi: '台阶', pinyin: 'tái jiē', meaning: 'Bậc thang', question: 'Chọn chữ Hán có nghĩa "Bậc thang":', options: ['台阶', '电梯', '楼梯', '坡道'], correctAnswer: '台阶' },
    ...
    { type: 'hanzi', hanzi: '烽火台', pinyin: 'fēng huǒ tái', meaning: 'Đài canh', question: 'Chọn chữ Hán có nghĩa "Đài canh":', options: ['烽火台', '城楼', '城门', '箭楼'], correctAnswer: '烽火台' },
    ...
    { type: 'hanzi', hanzi: '距离', pinyin: 'jù lí', meaning: 'Khoảng cách', question: 'Chọn chữ Hán có nghĩa "Khoảng cách":', options: ['距离', '长度', '宽度', '高度'], correctAnswer: '距离' },
    ...
    { type: 'hanzi', hanzi: '拍照', pinyin: 'pāi zhào', meaning: 'Chụp ảnh', question: 'Chọn chữ Hán có nghĩa "Chụp ảnh":', options: ['拍照', '录像', '画画', '写字'], correctAnswer: '拍照' },
